...
export const createTools = (
  ...
  // Where glrs keeps your extensions, skills and commands. The docs tell
  ...
  // checkouts — this repo is in one — and a blanket grant would let `write`
  // leave the project root into any of them, which is the opposite of what
  // confining writes is for.
  ...
  // Reading also reaches glrs's own docs. The system prompt hands the model
  ...
  // glrs repo itself, and the model routed around it with `bash cat` — a
