...
Numeric file and directory prefixes preserve this order and are removed from
visible page/group titles by frontmatter and the document-groups plugin. Group rows are labels, not pages or
